...
public:
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_configure(
        ...
        localize_slam_toolbox = std::make_shared<slam_toolbox::LocalizationSlamToolbox>(options);
    ...
    on_activate(const rclcpp_lifecycle::State &) override {
        ...
        localize_slam_toolbox->configure();
        localize_slam_toolbox->loadPoseGraphByParams();
        executor->add_node(localize_slam_toolbox->get_node_base_interface());
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_deactivate(
        ...
        executor->remove_node(localize_slam_toolbox->get_node_base_interface());
    ...
    on_cleanup(const rclcpp_lifecycle::State &) override {
        ...
        localize_slam_toolbox->shutdown();
        localize_slam_toolbox.reset();
...
private:
    ...
    std::shared_ptr<slam_toolbox::LocalizationSlamToolbox> localize_slam_toolbox;
};
